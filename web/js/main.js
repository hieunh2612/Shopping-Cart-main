...
function UpdateOrder(id) {
    var option = confirm('Bạn có muốn cập nhật đơn hàng: ' + id + ' không?');
    if (option === true) {
        // Thực hiện các bước cập nhật dữ liệu giỏ hàng ở đây

        // Chuyển hướng đến trang "Pending" với tham số oid là id của đơn hàng
        window.location.href = 'Pending?oid=' + id;
    }
}
